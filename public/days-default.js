  ...
  },
  {
   ...
   "exit": "https://docs.google.com/document/d/1DSFwsS2V4d9_GwrPjsxGdlth_IQ9DIk_kwdp7nFq9nI/edit?usp=sharing",
      ...
      },
      {
       ...
       "makecode":[{"url": "https://makecode.microbit.org/S79542-10060-01167-82601", "label": "MakeCode Project"},{"url": "https://makecode.microbit.org/S61805-34921-25084-54341", "label": "Launch Sequence Starter Code"}],
    ...
    "activities": [
      ...
      },
     {
    ...
    
      {
        ...
        "mins": 15,
        "block": "Open Lab",
        "description": "Track A (Data Dive): Check each stat value in your dashboard against the formula output. Fix any mismatches before tomorrow's first match. Track B (Bot Lab): Test a loadout you would never use competitively. What happens at Speed = 2 with Power = 15? Before you leave: the Launch Sequence Starter is the code you use for MATCHES from tomorrow on. Open it and set your six numbers -- your four stats on lines 1352-1355 (they must total 20), then your launch: lines 181 and 188 for how far each leg drives, 177 and 184 for the angles it turns.",
        "facilitatorDescription": "Give teams exactly 10 minutes to make one final adjustment to their launch sequence, then announce that sequences are locked. Circulate during those 10 minutes but do not coach; teams decide what to change. When time is called, confirm with each team that their final sequence is documented before closing. Then teams run the Pre-Match Checklist in order (Power, Endurance, Speed, Turning) with one person in the code and one checking the math. Circulate and ask to see calculations, not just answers. Any unresolved mismatch carries a PENDING into tomorrow's first match. CLOSE THE DAY by pointing every team at the Launch Sequence Starter -- that is the match code from tomorrow on, not the standalone Launch Test they tuned today. It is the full match program (launch, roam, find the ball, kick, stay in bounds) with their two-leg launch already dropped into STUDENT ZONE B. Six numbers change and nothing else: the four stats on lines 1352-1355 (must total exactly 20 or the micro:bit shows ERR) and the four launch numbers -- 181 and 188 set how far each leg drives, 177 and 184 set the turn angles. Remind them the line numbers only appear in MakeCode's JavaScript view.",
        "script": "https://docs.google.com/document/d/1tfwcohDC_tUJ700pCwIWLIa4j31qdFJoUgcJdhvyd1A/edit?usp=drive_link",
        "makecode": [
          { "url": "https://velocity-arena-gold.vercel.app/resources/teacher-guides/launch-starter.html", "label": "MATCH CODE from tomorrow — Launch Sequence Starter: set stats (lines 1352-1355) + launch (181/188 = distance, 177/184 = angles)" }
        ],
  ...
  },
  {
    ...
    "activities": [
    ...
    
      {
        ...
        "webpage": "/lessons/formula-race-cards.html",
