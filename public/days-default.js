  ...
  },
  {
    ...
    "activities": [
      ...
      },
      {
        ...
        "facilitatorDescription": "Teams complete a 12-problem interleaved set covering all four formula types (Turn Ratio = 0.2 + (TURNING x 0.02), follow through = Power x 80, Arc Segments = TURNING, and Speed/Endurance). Problems are shuffled so teams have to identify the formula before calculating. A concept tag column runs alongside each problem: teams name the concept (unit rate, ratio, linear decay, coordinate geometry, proportional scaling) before calculating. Teams must also lock in official allocation.",
