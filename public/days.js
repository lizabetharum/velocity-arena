...
const DAYS_NY3 = [
  {
    ...
    "activities": [
      { "name": "Best Match Gallery Walk + reset", "mins": 15, "block": "Hook",
        "description": "Before class the facilitator enters the 2 played matches into the dashboard. Look back at those matches, then: today we generate the rest of the Season 1 data." },
      { "name": "Set predictions (Season 1 — predictions only)", "mins": 25, "block": "Challenge Block",
        "description": "Each team writes its equation and a predicted result before playing. Stats stay locked this week.",
        "link": "/lessons/day13-prediction-log.html" },
      { "name": "Season 1 Final Round — Rounds 1-2", "mins": 80, "block": "Match-Build-Make",
  ...
  },
  {
    ...
    "activities": [
      ...
      { "name": "Percent change on your accuracy", "mins": 60, "block": "Challenge Block",
        ...
        "link": "/lessons/gotham-day14-percent-change.html" },
      { "name": "Lunch", "mins": 60, "block": "Lunch", "description": "One hour." },
      { "name": "Building and solving linear equations — your win equation", "mins": 60, "block": "Challenge Block",
        "description": "Turn your data into y = mx + b: what is your slope, what is your intercept, and what does each mean for your bot?",
        "link": "/lessons/linear-equations.html" },
