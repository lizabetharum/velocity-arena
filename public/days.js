...
const DAYS_NY3 = [
  ...
  },
  {
    ...
    "activities": [
      ...
      { "name": "Percent Change", "mins": 60, "block": "Challenge Block",
        ...
        "link": "/lessons/gotham-day14-percent-change.html" },
      { "name": "Skills Arena", "mins": 30, "block": "Open Lab",
        "description": "If time allows — sharpen driving: straight lines, exact turns, park on a spot.",
        "link": "/lessons/skills-arena.html" }
    ],
  ...
  },
  {
    ...
    "theme": "Proportional Scaling + reallocation + Commissioner prep",
    "bigMathIdea": "A straight-line stat (Motor Power = Speed x 5) scales by the same factor; a squared stat (Power squared) grows much faster. Season 2 opens: reallocate from your data.",
    "vocabulary": "PROPORTIONAL SCALING, REALLOCATION — Season 2 stat changes (Season 1 kept the loadout).",
    "activities": [
      ...
      { "name": "Underdog Mechanic announced + Season 2 stat reallocation", "mins": 60, "block": "Challenge Block",
      ...
      { "name": "Lunch", "mins": 60, "block": "Lunch", "description": "One hour." },
      { "name": "Practice Matches — test new loadout hypotheses", "mins": 75, "block": "Match-Build-Make",
        "description": "Run your new stats and see whether the change did what you predicted.",
        "link": "/resources/teacher-guides/run-a-match-simple.html" },
      { "name": "Open Lab — Commissioner Proposal Refinement", "mins": 45, "block": "Open Lab",
        "description": "Tighten your proposal with the numbers from practice.",
        "link": "/lessons/day11-commissioner-proposal.html" }
    ],
    "ends": "Stats reallocated and tested, a Commissioner proposal refined."
  },
  {
    "day": 4, "week": 2, "weekName": "Catch-Up · Season 2",
    "theme": "Commissioner's Meeting + Season 2 Allocation",
    "bigMathIdea": "Argue a rule change from data; then lock your Season 2 loadout, checking the tradeoffs before you commit.",
    "vocabulary": "PROPOSAL — a rule change backed by a number. TRADEOFF — what you give up to raise a stat.",
    "activities": [
      { "name": "Lobby the Commissioners", "mins": 30, "block": "Hook",
        "description": "Teams make their case to each other and count likely votes." },
      { "name": "Final Proposal Verification", "mins": 30, "block": "Challenge Block",
        "description": "Check that the math behind each proposal holds before it goes to a vote.",
        "link": "/lessons/proposal-verification.html" },
      { "name": "Commissioner's Meeting — formal presentations + vote", "mins": 60, "block": "Challenge Block",
        "description": "Each team presents; the class votes. Adopted rules take effect for the Season 2 matches.",
        "link": "/lessons/commissioner-meeting-worksheet.html" },
      { "name": "Lunch", "mins": 60, "block": "Lunch", "description": "One hour." },
      { "name": "Open Lab — Season 2 Allocation", "mins": 75, "block": "Open Lab",
        "description": "Lock in your Season 2 stats with the What-If Loadout Recalculator; check the tradeoffs before you commit.",
        "link": "/lessons/what-If-loadout-recalculator.html" },
      { "name": "Finalize + log your allocation", "mins": 45, "block": "Open Lab",
        "description": "Record your final loadout in the dashboard; Skills Arena if time.",
        "link": "/activities/dashboard/velocity-arena-dashboard.html" }
    ],
    "ends": "The class voted on a rule change and every team locked its Season 2 loadout."
  },
  {
    "day": 5, "week": 2, "weekName": "Catch-Up · Season 2",
    "theme": "Bot Lore + Season 2 Match Day 1 + poster",
    "bigMathIdea": "Test your new loadout in matches: predict with your equation, log predicted vs. actual, and see the residual shrink.",
    "vocabulary": "RESIDUAL — predicted minus actual. LORE — your bot's story, updated by the data.",
    "activities": [
      { "name": "Bot Lore Gallery Walk", "mins": 30, "block": "Hook",
        "description": "Re-read every bot's origin story; add one sentence that only makes sense after the seasons you've played." },
      { "name": "Season 2 Match Day 1 — Rounds 1-2", "mins": 90, "block": "Match-Build-Make",
        "description": "Predict before each with your new loadout; log predicted vs. actual right after.",
        "link": "/resources/teacher-guides/run-a-match-simple.html" },
      { "name": "Lunch", "mins": 60, "block": "Lunch", "description": "One hour." },
      { "name": "Season 2 Match Day 1 — Round 3 + log", "mins": 45, "block": "Match-Build-Make",
        "description": "Finish the rounds and confirm every result is in the dashboard.",
        "link": "/activities/dashboard/velocity-arena-dashboard.html" },
      { "name": "Create your poster", "mins": 45, "block": "Match-Build-Make",
        "description": "Your equation, a graph of your data, and your percent-change result.",
        "link": "/lessons/equation-poster.html" },
      { "name": "Skills Arena", "mins": 30, "block": "Open Lab",
        "description": "Sharpen driving — straight lines, exact turns, park on a spot.",
        "link": "/lessons/skills-arena.html" }
    ],
    "ends": "Season-2 Match Day 1 logged, bot lore updated, poster started."
  },
  {
    "day": 6, "week": 2, "weekName": "Catch-Up · Season 2",
    "theme": "Season 2 Match Day 2 + Teach the Math + Post-Task",
    "bigMathIdea": "You understand it when you can teach it. Explain your equation so a stranger can use it after one explanation. Then show your growth since Day 1.",
    ...
    "activities": [
      ...
      { "name": "Teach the Math", "mins": 45, "block": "Challenge Block",
        "description": "Explain your equation in plain words with your real numbers. A partner plays a confused visitor and tries it once.",
      ...
      { "name": "Open Lab — Reflection Time", "mins": 40, "block": "Open Lab",
        "description": "Set up the exhibition station between reflections.",
        "link": "/lessons/open-lab-reflection.html" },
      { "name": "Skills Arena", "mins": 30, "block": "Open Lab",
        "description": "If there is extra time.",
        "link": "/lessons/skills-arena.html" }
    ],
    "ends": "Season-2 Match Day 2 logged; Post-Task + Reflection done."
  },
  {
    ...
    "vocabulary": "EXPLANATION — a visitor succeeds after one of yours.",
    "activities": [
      { "name": "Expert Setup", "mins": 45, "block": "Hook",
        "description": "Stations ready — poster, bot, and dashboard on display; last rehearsal of your one sentence." },
      { "name": "Community Exhibition — teaching begins + Best Teacher voting", "mins": 75, "block": "Match-Build-Make",
        ...
        "link": "/resources/teacher-guides/visitor-teach-handout.html" },
      { "name": "Lunch", "mins": 60, "block": "Lunch", "description": "One hour." },
      { "name": "Walk the Wall — final gallery", "mins": 45, "block": "Open Lab",
        "description": "Every artifact from the run on display; students walk it quietly and take it in." },
      ...
      { "name": "Open Lab — final debrief", "mins": 30, "block": "Open Lab",
