...
const DAYS_NY3 = [
  ...
  },
  {
    ...
    "activities": [
      ...
      { "name": "Practice Matches — test new loadout hypotheses", "mins": 75, "block": "Match-Build-Make",
        "description": "Individual practice — run your new stats and see whether the change did what you predicted.",
  ...
  },
  {
    ...
    "bigMathIdea": "A proposal only counts if the number behind it holds up. Verify every cited number against the dashboard, then vote proposals into permanent Season 2 rules.",
    "vocabulary": "PROPOSAL — a rule change backed by a number. VERIFICATION — checking a cited number is real.",
    "activities": [
      { "name": "Lobby the Commissioners", "mins": 45, "block": "Hook",
        "description": "Circulate and pitch your proposal to other teams — here's our proposal, here's the number behind it. Count likely votes.",
        "quickCard": "https://velocity-arena-gold.vercel.app/resources/quick-cards/activity-card-day12-01-lobby-commissioners.html" },
      { "name": "Final Proposal Verification", "mins": 75, "block": "Challenge Block",
      ...
      { "name": "Lunch", "mins": 60, "block": "Lunch", "description": "One hour." },
      { "name": "Commissioner's Meeting: Formal Presentations + Vote", "mins": 90, "block": "Match-Build-Make",
      ...
      { "name": "Open Lab: Season 2 Allocation", "mins": 30, "block": "Open Lab",
        "description": "Enter the rules that passed and each team's starting stats; lock your Season 2 loadout.",
    ...
    "ends": "The class voted proposals into permanent Season 2 rules and every team locked its loadout."
  },
  {
  ...
  },
  {
    ...
    "activities": [
      ...
      { "name": "Skills Arena", "mins": 30, "block": "Open Lab",
        "description": "If there is extra time. Click the Done button at the end of each challenge to unlock the next.",
        "link": "/lessons/skills-arena.html" }
    ],
